...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body class="bc">
		...
		<div class="titolo">
			<h1>Spedizioni in sospeso</h1>
			<p><em>Clicca sul codice della spedizione per prenderla in carico</em></p>
		</div>
...
<?php
	function stampa_in_sospeso() {
		...
		for($i=0; $i<$spedizioni->length; $i++){
			...
			if($statoX == "In sospeso" && $autoX == "si"){
				...
				$sped.= "<div class = \"sopra\" style = \"background-color: rgba(192, 192, 192,0.7);\"><p><strong> CODICE SPEDIZIONE </strong>
							<input class=\"bottone\" type=\"submit\" name=\"sospeso\" value=\"".$id_spedizioneX."\" /> Clicca sul bottone per prendere in carico la richiesta di spedizione
						 </p></form></div>\n";
				$sped.= "<table>\n
							<tbody>\n
								<tr>
		...
		if($occorrenza == 0)
			echo "<p style = \"text-align: center;\"><strong>Non ci sono richieste di spedizione in sospeso</strong></p>";
