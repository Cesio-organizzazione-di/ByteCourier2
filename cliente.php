...
<?php
	function cliente() {
		...
		if($row['tipo_utente'] == "cli_p") {
			...
			$profilo.= "<div class = \"info\"><strong>Nome attivita: </strong>".$row['nome_attivita']."</div>";
			$profilo.= "<div class = \"info\"><strong>Codice fiscale: </strong>".$row['cf']."</div>";
			$profilo.= "<div class = \"info\"><strong>Partita IVA: </strong>".$row['p_iva']."</div>";
			$profilo.= "<div class = \"info\"><strong>Settore: </strong>".$row['settore']."</div>";
			$profilo.= "<div class = \"indirizzo\"><u>Indirizzo:</u> <br />";
			$profilo.= "<strong>Via: </strong>".$row['via']." ".$row['n_civico']."<br />";
			$profilo.= "<strong>Citt&agrave;: </strong>".$row['citta'].", ";
			$profilo.= $row['CAP']."<br />";
